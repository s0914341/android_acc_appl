	...
	public void onCreate(Bundle savedInstanceState) {
	  ...
	  //把資料加入ArrayList中
	    ...
	    for (int i = 0; i < 5; i++) {
            ...
            item_string_view.put(key_repeat_from,"from："+"3" );
            item_string_view.put(key_repeat_count, "count："+"5");
            item_string_view.put(key_repeat_time, "time："+"30"+"min");
	        item_string_view.put(key_shaker_argument, "shaker command："+"set speed");
